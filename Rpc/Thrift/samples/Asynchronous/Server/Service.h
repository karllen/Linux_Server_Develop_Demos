...
class ServiceCobClient;

class ServiceCobClIf {
 public:
  virtual ~ServiceCobClIf() {}
  virtual void echoVoid(::apache::thrift::stdcxx::function<void(ServiceCobClient* client)> cob) = 0;
  virtual void echoByte(::apache::thrift::stdcxx::function<void(ServiceCobClient* client)> cob, const int8_t arg) = 0;
  virtual void echoI32(::apache::thrift::stdcxx::function<void(ServiceCobClient* client)> cob, const int32_t arg) = 0;
  virtual void echoI64(::apache::thrift::stdcxx::function<void(ServiceCobClient* client)> cob, const int64_t arg) = 0;
  virtual void echoString(::apache::thrift::stdcxx::function<void(ServiceCobClient* client)> cob, const std::string& arg) = 0;
  virtual void echoList(::apache::thrift::stdcxx::function<void(ServiceCobClient* client)> cob, const std::vector<int8_t> & arg) = 0;
  virtual void echoSet(::apache::thrift::stdcxx::function<void(ServiceCobClient* client)> cob, const std::set<int8_t> & arg) = 0;
  virtual void echoMap(::apache::thrift::stdcxx::function<void(ServiceCobClient* client)> cob, const std::map<int8_t, int8_t> & arg) = 0;
};

class ServiceCobSvIf {
 public:
  virtual ~ServiceCobSvIf() {}
  virtual void echoVoid(::apache::thrift::stdcxx::function<void()> cob) = 0;
  virtual void echoByte(::apache::thrift::stdcxx::function<void(int8_t const& _return)> cob, const int8_t arg) = 0;
  virtual void echoI32(::apache::thrift::stdcxx::function<void(int32_t const& _return)> cob, const int32_t arg) = 0;
  virtual void echoI64(::apache::thrift::stdcxx::function<void(int64_t const& _return)> cob, const int64_t arg) = 0;
  virtual void echoString(::apache::thrift::stdcxx::function<void(std::string const& _return)> cob, const std::string& arg) = 0;
  virtual void echoList(::apache::thrift::stdcxx::function<void(std::vector<int8_t>  const& _return)> cob, const std::vector<int8_t> & arg) = 0;
  virtual void echoSet(::apache::thrift::stdcxx::function<void(std::set<int8_t>  const& _return)> cob, const std::set<int8_t> & arg) = 0;
  virtual void echoMap(::apache::thrift::stdcxx::function<void(std::map<int8_t, int8_t>  const& _return)> cob, const std::map<int8_t, int8_t> & arg) = 0;
};

class ServiceCobSvIfFactory {
 public:
  typedef ServiceCobSvIf Handler;

  virtual ~ServiceCobSvIfFactory() {}

  virtual ServiceCobSvIf* getHandler(const ::apache::thrift::TConnectionInfo& connInfo) = 0;
  virtual void releaseHandler(ServiceCobSvIf* /* handler */) = 0;
};

class ServiceCobSvIfSingletonFactory : virtual public ServiceCobSvIfFactory {
 public:
  ServiceCobSvIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<ServiceCobSvIf>& iface) : iface_(iface) {}
  virtual ~ServiceCobSvIfSingletonFactory() {}

  virtual ServiceCobSvIf* getHandler(const ::apache::thrift::TConnectionInfo&) {
    return iface_.get();
  }
  virtual void releaseHandler(ServiceCobSvIf* /* handler */) {}

 protected:
  ::apache::thrift::stdcxx::shared_ptr<ServiceCobSvIf> iface_;
};

class ServiceCobSvNull : virtual public ServiceCobSvIf {
 public:
  virtual ~ServiceCobSvNull() {}
...
class ServiceCobClient : virtual public ServiceCobClIf {
 public:
  ServiceCobClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::async::TAsyncChannel> channel, ::apache::thrift::protocol::TProtocolFactory* protocolFactory) :
    channel_(channel),
  ...
  void echoVoid(::apache::thrift::stdcxx::function<void(ServiceCobClient* client)> cob);
  void send_echoVoid();
  void recv_echoVoid();
  void echoByte(::apache::thrift::stdcxx::function<void(ServiceCobClient* client)> cob, const int8_t arg);
  void send_echoByte(const int8_t arg);
  int8_t recv_echoByte();
  void echoI32(::apache::thrift::stdcxx::function<void(ServiceCobClient* client)> cob, const int32_t arg);
  void send_echoI32(const int32_t arg);
  int32_t recv_echoI32();
  void echoI64(::apache::thrift::stdcxx::function<void(ServiceCobClient* client)> cob, const int64_t arg);
  void send_echoI64(const int64_t arg);
  int64_t recv_echoI64();
  void echoString(::apache::thrift::stdcxx::function<void(ServiceCobClient* client)> cob, const std::string& arg);
  void send_echoString(const std::string& arg);
  void recv_echoString(std::string& _return);
  void echoList(::apache::thrift::stdcxx::function<void(ServiceCobClient* client)> cob, const std::vector<int8_t> & arg);
  void send_echoList(const std::vector<int8_t> & arg);
  void recv_echoList(std::vector<int8_t> & _return);
  void echoSet(::apache::thrift::stdcxx::function<void(ServiceCobClient* client)> cob, const std::set<int8_t> & arg);
  void send_echoSet(const std::set<int8_t> & arg);
  void recv_echoSet(std::set<int8_t> & _return);
  void echoMap(::apache::thrift::stdcxx::function<void(ServiceCobClient* client)> cob, const std::map<int8_t, int8_t> & arg);
  void send_echoMap(const std::map<int8_t, int8_t> & arg);
  void recv_echoMap(std::map<int8_t, int8_t> & _return);
 protected:
...
class ServiceAsyncProcessor : public ::apache::thrift::async::TAsyncDispatchProcessor {
 protected:
  ::apache::thrift::stdcxx::shared_ptr<ServiceCobSvIf> iface_;
 ...
 private:
  typedef  void (ServiceAsyncProcessor::*ProcessFunction)(::apache::thrift::stdcxx::function<void(bool ok)>, int32_t, ::apache::thrift::protocol::TProtocol*, ::apache::thrift::protocol::TProtocol*);
  typedef std::map<std::string, ProcessFunction> ProcessMap;
  ProcessMap processMap_;
  void process_echoVoid(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_echoVoid(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx);
  void throw_echoVoid(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_echoByte(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_echoByte(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const int8_t& _return);
  void throw_echoByte(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_echoI32(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_echoI32(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const int32_t& _return);
  void throw_echoI32(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_echoI64(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_echoI64(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const int64_t& _return);
  void throw_echoI64(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_echoString(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_echoString(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::string& _return);
  void throw_echoString(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_echoList(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_echoList(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<int8_t> & _return);
  void throw_echoList(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_echoSet(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_echoSet(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::set<int8_t> & _return);
  void throw_echoSet(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
  void process_echoMap(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot);
  void return_echoMap(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::map<int8_t, int8_t> & _return);
  void throw_echoMap(::apache::thrift::stdcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw);
 public:
  ServiceAsyncProcessor(::apache::thrift::stdcxx::shared_ptr<ServiceCobSvIf> iface) :
    iface_(iface) {
    processMap_["echoVoid"] = &ServiceAsyncProcessor::process_echoVoid;
    processMap_["echoByte"] = &ServiceAsyncProcessor::process_echoByte;
    processMap_["echoI32"] = &ServiceAsyncProcessor::process_echoI32;
    processMap_["echoI64"] = &ServiceAsyncProcessor::process_echoI64;
    processMap_["echoString"] = &ServiceAsyncProcessor::process_echoString;
    processMap_["echoList"] = &ServiceAsyncProcessor::process_echoList;
    processMap_["echoSet"] = &ServiceAsyncProcessor::process_echoSet;
    processMap_["echoMap"] = &ServiceAsyncProcessor::process_echoMap;
  }

  virtual ~ServiceAsyncProcessor() {}
};

class ServiceAsyncProcessorFactory : public ::apache::thrift::async::TAsyncProcessorFactory {
 public:
  ServiceAsyncProcessorFactory(const ::apache::thrift::stdcxx::shared_ptr< ServiceCobSvIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr< ServiceCobSvIfFactory > handlerFactory_;
};
